...
/// @title UmaCtfAdapterDemo - Demo adapter for testing purposes with a 10 second safety period
/// @notice Enables resolution of Polymarket CTF markets via UMA's Optimistic Oracle
contract UmaCtfAdapterDemo is IUmaCtfAdapter, Auth, BulletinBoard, IOptimisticRequester {
    /*///////////////////////////////////////////////////////////////////
                            IMMUTABLES
    //////////////////////////////////////////////////////////////////*/
    ...
    uint256 public constant SAFETY_PERIOD = 10 seconds;
